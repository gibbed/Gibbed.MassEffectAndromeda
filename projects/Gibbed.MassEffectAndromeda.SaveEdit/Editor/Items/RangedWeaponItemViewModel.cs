...
{
    internal class RangedWeaponItemViewModel : GearItemViewModel
    {
        #region Fields
        private readonly RangedWeaponItemData _Item;
        #endregion

        public RangedWeaponItemViewModel(uint id, RangedWeaponItemData item)
            : base(id, item)
        {
            this._Item = item;
        }
