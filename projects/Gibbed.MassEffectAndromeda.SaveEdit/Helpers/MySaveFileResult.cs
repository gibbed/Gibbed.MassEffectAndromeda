...
namespace Gibbed.MassEffectAndromeda.SaveEdit
{
    ...
    /// </summary>
    internal class MySaveFileResult : IResult
    {
        ...
        /// <summary>
        /// Sets the inital <paramref name="title" /> of the dialog
        /// </summary>
        /// <param name="title"></param>
        /// <returns></returns>
        public MySaveFileResult WithTitle(string title)
        {
            this._Title = title;
            return this;
        }
        ...
        /// <summary>
        /// Sets the inital <paramref name="defaultExtension" /> of the dialog
        /// </summary>
        /// <param name="defaultExtension">default extension</param>
        /// <returns></returns>
        public MySaveFileResult WithDefaultExtension(string defaultExtension)
        {
        ...
        public MySaveFileResult WithFilterIndexDo(Action<int> action)
        {
        ...
        /// <returns></returns>
        public MySaveFileResult FilterFiles(Action<MyFileFilterCollection> action)
        {
            if (action == null)
            {
