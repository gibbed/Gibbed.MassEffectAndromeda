...
namespace Gibbed.Frostbite3.ResourceFormats.Partition
{
    internal struct TypeDefinitionEntry
    {
        ...
        public static TypeDefinitionEntry Read(Stream input, Endian endian)
        {
            ...
            instance.Unknown0E = input.ReadValueU16(endian);
            instance.Name = null;
            return instance;
        }
        ...
        {
            return string.Format("{0}; {1}", this.Name ?? "#" + this.NameHash.ToString("X8"), this.Flags);
        }
    }
}
